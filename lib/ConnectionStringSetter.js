...
class ConnectionStringSetter {
    ...
    setConnectionString() {
        ...
        if (this._platform === 'win32') {
            ...
            this.setConnectionStringForLinux(servicePrincipal, servicePrincipalTenant, servicePrincipalSecret, resourceGroup, appService, connectionStringType, connectionString);
        }
        console.log('Done setting connection string');
    }
    setConnectionStringForLinux(servicePrincipal, servicePrincipalTenant, servicePrincipalSecret, resourceGroup, appService, connectionStringType, connectionString) {
