...
class ConnectionStringSetter {
    ...
    setConnectionString() {
        ...
        let azureSubscriptionName = this._coreLib.getInput('azureSubsdriptionName');
        ...
        if (this._platform === 'win32') {
            ...
            this.setConnectionStringForLinux(servicePrincipal, servicePrincipalTenant, servicePrincipalSecret, azureSubscriptionName, resourceGroup, appService, connectionStringType, connectionString);
        }
    }
    setConnectionStringForLinux(servicePrincipal, servicePrincipalTenant, servicePrincipalSecret, azureSubscriptionName, resourceGroup, appService, connectionStringType, connectionString) {
